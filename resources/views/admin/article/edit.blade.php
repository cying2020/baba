<form action="{{url('/article/update/'.$data->a_id)}}" method="post" enctype="multipart/form-data">
   @csrf
    <table>
        <tr>
            <td>文章标题</td>
            <td><input type="text" name="a_biaoti" value="{{$data->a_biaoti}}">
            </td>
        </tr>
        <tr>
            <td>文章分类</td>
        ...
        <tr>
            <td>文章作者</td>
            <td><input type="text" name="a_zuozhe" value="{{$data->a_zuozhe}}"></td>
        </tr>
        <tr>
            <td>作者email</td>
        ...
        <tr>
            <td>关键字</td>
            <td><input type="text" name="a_guan" value="{{$data->a_guan}}"></td>
        </tr>
        <tr>
            <td>网页描述</td>
            <td><textarea name="a_desc">{{$data->a_desc}}</textarea></td>
        </tr>
        <tr>
            <td>上传文件</td>
